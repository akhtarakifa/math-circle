...
export const sidebarItems: SidebarItem[] = [
  { id: 'hero',           label: 'Beranda',        href: '#hero',           icon: '◉' },
  { id: 'definisi',       label: 'Definisi',       href: '#definisi',       icon: '○' },
  { id: 'unsur',          label: 'Unsur-Unsur',    href: '#unsur',          icon: '✦' },
  { id: 'keliling',       label: 'Keliling',       href: '#keliling',       icon: '↻' },
  { id: 'luas',           label: 'Luas',           href: '#luas',           icon: '▣' },
  { id: 'busur-juring',   label: 'Busur & Juring', href: '#busur-juring',   icon: '⌒' },
  ...
  { id: 'kuis',           label: 'Kuis',           href: '#kuis',           icon: '✎' },
];
